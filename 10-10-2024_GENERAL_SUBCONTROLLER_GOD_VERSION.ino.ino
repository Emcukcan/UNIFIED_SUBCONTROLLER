    ...
    if (String1MaxCellModbus  < 4.8  && String1MinCellModbus  < 4.8  && String1SOC < 105  && abs(String1Current) < 1000 && String1MaxCellModbus  > 2.2 && String1MinCellModbus  > 2.2 && String1Voltage < 1000 && String1Voltage > 90 ) {
      ...
      if (InverterType == 1) {
        ...
        if (String1SOC < 99) {
          ...
          if (String1Temp < INVTempLim) {

            if (String1MaxCellModbus < INVMaxCellLim) {

              if (String1SOC > INVSOCLim)
            ...
            else if (String1MaxCellModbus >= INVMaxCellLim && String1MaxCellModbus < INVMaxCellLim + 0.02) {
              set_totalvoltage(String1Voltage , String1Current , MaxCurrent * 0.4, MaxCurrent, 0x180250F1);
              ThrottleCH = 40;
              ThrottleDS = 100;
            }

            else if (String1MaxCellModbus >= INVMaxCellLim + 0.02 && String1MaxCellModbus < INVMaxCellLim + 0.04) {
              set_totalvoltage(String1Voltage , String1Current , MaxCurrent * 0.2, MaxCurrent, 0x180250F1);
              ThrottleCH = 20;
              ThrottleDS = 100;
            }

            else if (String1MaxCellModbus >= INVMaxCellLim + 0.04 && String1MaxCellModbus < INVMaxCellLim + 0.06) {
              set_totalvoltage(String1Voltage , String1Current , MaxCurrent * 0.1, MaxCurrent, 0x180250F1);
              ThrottleCH = 10;
              ThrottleDS = 100;
            }
            else if (String1MaxCellModbus >= INVMaxCellLim + 0.06 && String1MaxCellModbus < INVMaxCellLim + 0.08) {
              set_totalvoltage(String1Voltage , String1Current , MaxCurrent * 0.05, MaxCurrent, 0x180250F1);
              ThrottleCH = 5;
              ThrottleDS = 100;
            }
